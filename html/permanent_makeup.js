const { imagesSection, termsOfServiceSection, signatureSection, holdHarmlessSection, artistSection, skinConditionSection, frontDeskSection, tattooStyleSection, consentSection, doctorDetails, emergencyDetails, medicalSection, userDetails } = require("./templates/detailsSection");
const { consentSection_s, tattooStyleSection_s, frontDeskSection_s, skinConditionSection_s, artistSection_s, holdHarmlessSection_s, signatureSection_s, termsOfServiceSection_s, doctorDetails_s, emergencyDetails_s, medicalSection_s, userDetails_s } = require("./templates/detailsSectionSpanish");



function Permanent_markeup_english_not_minor(parsedData){
         return (
        `
<!DOCTYPE html>
<html lang="en">
...
<p class="s1" style="padding-left: 7pt;text-indent: 0pt;text-align: center;">WAIVER, RELEASE AND CONSENT TO TATTOO
</p>
...
function Permanent_markeup_english_minor(parsedData){
    return (
   `
<!DOCTYPE html>
<html lang="en">
...
function Permanent_markeup_spanish_not_minor(parsedData){
    return (
   `
<!DOCTYPE html>
<html lang="en">
...
function Permanent_markeup_spanish_minor(parsedData){
    return (
   `
<!DOCTYPE html>
<html lang="en">
...
module.exports={Permanent_markeup_english_not_minor,Permanent_markeup_english_minor,Permanent_markeup_spanish_not_minor,Permanent_markeup_spanish_minor};
