...
const { consentSection_s, tattooStyleSection_s, frontDeskSection_s, skinConditionSection_s, artistSection_s, holdHarmlessSection_s, signatureSection_s, termsOfServiceSection_s, emergencyDetails_s, doctorDetails_s, userDetails_s, medicalSection_s } = require("./templates/detailsSectionSpanish");



function tattoo_english_not_minor(parsedData){
  return (
 `
<!DOCTYPE html>
<html lang="en">
...
function tattoo_english_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
function tattoo_spanish_not_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
function tattoo_spanish_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
module.exports = {
  tattoo_english_not_minor,
  tattoo_english_minor,
  tattoo_spanish_not_minor,
  tattoo_spanish_minor,
};
