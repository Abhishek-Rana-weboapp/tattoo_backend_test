const { userDetails, medicalSection, emergencyDetails, doctorDetails, consentSection, tattooStyleSection, frontDeskSection, skinConditionSection, artistSection, holdHarmlessSection, signatureSection, termsOfServiceSection, imagesSection } = require("./templates/detailsSection");
const { medicalSection_s, userDetails_s, emergencyDetails_s, doctorDetails_s, consentSection_s, tattooStyleSection_s, frontDeskSection_s, skinConditionSection_s, artistSection_s, holdHarmlessSection_s, signatureSection_s, termsOfServiceSection_s } = require("./templates/detailsSectionSpanish");
...
function Piercing_english_not_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
<p class="s1" style="padding-left: 7pt;text-indent: 0pt;text-align: center;">WAIVER, RELEASE AND CONSENT FOR PIERCING
</p>
...
function Piercing_english_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
<p class="s3" style="padding-left: 7pt;text-indent: 0pt;text-align: center;">WAIVER, RELEASE AND CONSENT FOR PIERCING
</p>
...
function Piercing_spanish_not_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
<p class="s3" style="padding-left: 7pt;text-indent: 0pt;text-align: center;">RENUNCIA, LIBERACIÓN Y CONSENTIMIENTO PARA PERFORAR
</p>
...
function Piercing_spanish_minor(parsedData) {
  return `
<!DOCTYPE html>
<html lang="en">
...
<p style="padding-top: 4pt;padding-left: 7pt;text-indent: 0pt;text-align: center;">Los siguientes colores indican las secciones completadas por cada persona: Menores son </span><span
            class="s2" style=" background-color: #0F0;">Verde</span><span class="h3">, Guardián legal son </span><span
            class="s3" style=" background-color: #FF0;">Amarillo</span></p>
...
module.exports = {
  Piercing_english_not_minor,
  Piercing_english_minor,
  Piercing_spanish_not_minor,
  Piercing_spanish_minor,
};
